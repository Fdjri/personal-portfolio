...
const MainLanding = memo(function MainLanding() {
  return (
    <>
      <Header />
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 pt-20 perspective-[1000px]">
        ...
        <div className="text-center space-y-8 max-w-4xl relative z-20 pointer-events-none">
          <div className="min-h-[120px] flex flex-col items-center justify-center pointer-events-auto">
            <h1 className="text-3xl sm:text-5xl md:text-8xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-b from-white to-slate-500 mb-2 drop-shadow-2xl">
              <ScrambleText text="Sholihul Fadjri" delay={500} />
            </h1>
            <h1 className="text-3xl sm:text-5xl md:text-8xl font-bold tracking-tight text-slate-600">
              <ScrambleText text="Triwibowo" delay={1000} className="text-slate-600" />
            </h1>
          </div>

          <div className="flex items-center justify-center gap-2 text-cyan-400 text-sm sm:text-lg md:text-2xl h-8 pointer-events-auto">
            <TypewriterCycler
              words={[
          ...
          <motion.div
            ...
            className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-8 pointer-events-auto w-full px-4 sm:px-0"
          >
            <Link href="/about" className="w-full sm:w-auto group relative px-8 py-3 bg-white text-black font-bold rounded-lg overflow-hidden transition-all hover:scale-105 active:scale-95 shadow-[0_0_20px_rgba(255,255,255,0.3)] flex items-center justify-center">
            ...
            <Link href="/contact" className="w-full sm:w-auto px-8 py-3 border border-slate-700 bg-black/50 text-white rounded-lg hover:bg-slate-900 hover:border-slate-500 transition-all flex items-center justify-center gap-2 group backdrop-blur-sm">
              Get In Touch
